            ...
            <div className="max-w-md w-full text-center space-y-8 p-12 rounded-[3rem] border border-gray-100 shadow-2xl">
                ...
                <div className="pt-6 space-y-3">
                    <button 
                        ...
                        className="w-full flex items-center justify-center gap-2 bg-black text-white py-4 rounded-2xl font-black text-xs uppercase hover:bg-[#FF8C00] transition-all"
                    >
                        <ShoppingBag size={18} /> View My Orders
                    </button>
                    <button 
                        onClick={() => navigate('/')}
                        className="w-full text-gray-400 font-black text-[10px] uppercase tracking-[0.2em] hover:text-black transition-colors"
                    >
                        Back to Gallery
                    </button>
                </div>
