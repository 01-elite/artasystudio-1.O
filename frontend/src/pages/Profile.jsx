...
const Profile = () => {
    // Freshly read user state from localStorage to show real-time follow counts
            ...
            <div className="flex items-center gap-10 mb-16 border-b pb-12 border-gray-100">
                ...
                <div>
                    ...
                    <div className="flex gap-8">
                        <div>
                            <span className="block text-xl font-black">{allArt.length}</span>
                            <span className="text-[10px] text-gray-400 uppercase font-bold tracking-widest">Submissions</span>
                        </div>
                        <div>
                            <span className="block text-xl font-black">{user.followers?.length || 0}</span>
                            <span className="text-[10px] text-gray-400 uppercase font-bold tracking-widest">Followers</span>
                        </div>
                        <div>
                            <span className="block text-xl font-black">{user.following?.length || 0}</span>
                            <span className="text-[10px] text-gray-400 uppercase font-bold tracking-widest">Following</span>
                        </div>
                    </div>
                </div>
            </div>
